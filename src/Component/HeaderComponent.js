    ...
    render(){
        return(
            <React.Fragment>
                ...
                <div class="jumbotron container-fluid text-sm-center p-5">
                    <div row row-header>
                        <div className="col-12 col-sm-6">
                            <h1 class="display-2">Tadka Restaurant</h1>
...
/**
 * 
 * Before binding the this.toggleNav function, we were using arrow function, when we were required to call that function.
 * 
 * Binding is other way of doing the same thing.
 */